...
{#if pageLoaded}
	...
	>
		...
		<div id="content" style="background-color: #f7fafc">
			<div id="projects">
				<div class="max-w-6xl mx-auto px-6 py-10 sm:py-20">
					<h2
						class="scroll-el mt-6 text-3xl tracking-tight font-bold text-gray-900 sm:text-4xl md:text-5xl text-center"
					>
						Projects
					</h2>
					<div class="md:flex mt-12 mb-12 md:mb-16">
						{#each items as item}
							<div class="scroll-el project sm:flex-1 px-4 lg:px-8 mb-8 md:mb-0">
								<a href={item.url} target="_blank" rel="noopener">
									<div
										class="bg-white dark:bg-black dark:text-white enlarge text-center text-base rounded-lg border-t-6 border-primary shadow-lg h-full px-8 md:px-12 py-8"
									>
										<div class="flex justify-center mt-5 mb-6">
											<div class="flex items-center h-24 dark:bg-white/20 p-3">
												<img src={item.img_url} class="max-h-full" alt="" />
											</div>
										</div>
										<p
											class="mb-6 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 dark:text-white"
										>
		...
		<div id="about" class="scroll-section relative bg-white overflow-hidden">
