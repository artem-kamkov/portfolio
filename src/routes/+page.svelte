...
{#if pageLoaded}
	...
	>
		<div id="header" class="bg-black relative text-lg">
				...
				<div class="relative container px-4 mx-auto text-[var(--color-contrast)] py-6 pb-32">
					<div class="sm:flex text-center">
						<div class="sm:flex-1 text-2xl font-bold sm:text-left mb-4">
							<a href="/" class=" start-anim scroll-anim hover:underline">Artem Kamkov</a>
						</div>
			...
			>
				<polygon
					class="fill-[var(--color-bg-primary)] dark:fill-[var(--color-bg-secondary)]"
			...
			<div id="projects">
				<div class="max-w-6xl mx-auto px-6 py-10 sm:py-20">
					...
					<div class="md:flex mt-12 mb-12 md:mb-16">
						{#each items as item}
							<div class="scroll-anim project sm:flex-1 px-4 lg:px-8 mb-8 md:mb-0">
								<a href={item.url} target="_blank" rel="noopener">
									...
									>
										<div class="flex justify-center mt-5 mb-6">
											<div class="flex items-center h-24 dark:bg-[var(--color-bg-primary)]/20 p-3">
												<img src={item.img_url} class="max-h-full" alt="" />
											</div>
										</div>
										<p
											class="mb-6 text-base text-[var(--color-secondary)] sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"
										>
